-- CORRIGIR SCHEMA DOS AGENDAMENTOS - BRAVO CONSÓRCIOS
-- Execute este SQL no Supabase para corrigir os erros

-- 1. PRIMEIRO, REMOVER A VIEW EXISTENTE
DROP VIEW IF EXISTS bookings_with_lead;

-- 2. ADICIONAR NOVOS CAMPOS NA TABELA consultation_bookings
...
-- 3. CRIAR TABELA PARA TRACKING DE EVENTOS
...
-- 4. RECRIAR A VIEW bookings_with_lead COM OS NOVOS CAMPOS
CREATE VIEW bookings_with_lead AS
SELECT 
  cb.id,
  cb.lead_id,
  l.name,
...
-- 5. CRIAR VIEW PARA DASHBOARD DE PERFORMANCE
...
-- 6. CRIAR POLÍTICAS PARA AS NOVAS TABELAS
