...
const AnimatedStat: React.FC<{ end: number; suffix?: string; prefix?: string }> = ({ end, suffix = '', prefix = '' }) => {
  ...
  return (
    <div ref={elementRef} className="text-3xl md:text-4xl font-bold text-orange-400 mb-2">
      {count}
    </div>
  );
};
...
const CaminhoesPage: React.FC = () => {
  ...
  useEffect(() => {
    trackingService.trackPageView('Caminhões Page');
  }, []);
  ...
  const trucksAnimation = useStaggeredFadeIn({ 
    itemCount: 4, 
    staggerDelay: 200, 
    direction: 'up' 
  });
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Nossa metodologia exclusiva garante contemplação em média 10-14 meses para caminhões.",
    ...
    },
    {
      ...
      description: "Acompanhamento especializado desde a adesão até a contemplação do seu caminhão.",
  ...
  const trucks = [
    {
      ...
      examples: ["Volkswagen Delivery", "Iveco Daily", "Mercedes-Benz Sprinter", "Ford Transit"],
      priceRange: "R$ 80.000 - R$ 200.000",
      icon: Truck,
      color: "from-orange-500 to-red-600"
    },
    {
      category: "Caminhões Médios",
      examples: ["Volkswagen Constellation", "Iveco Tector", "Mercedes-Benz Atego", "Ford Cargo"],
    ...
    },
    {
      ...
      examples: ["Volvo FH", "Scania R-Series", "Mercedes-Benz Actros", "Iveco Stralis"],
      priceRange: "R$ 300.000 - R$ 600.000",
      icon: Fuel,
      color: "from-purple-500 to-violet-600"
    },
    {
      category: "Caminhões Especiais",
      examples: ["Caminhão Basculante", "Caminhão Tanque", "Caminhão Guindaste", "Caminhão Betoneira"],
  ...
  const process = [
    {
      ...
      description: "Analisamos seu perfil e simulamos as melhores opções de consórcio para seu caminhão dos sonhos.",
      icon: Calculator,
      color: "from-orange-500 to-red-600"
    },
    {
  ...
  const stats = [
    ...
    { end: 12, suffix: '', label: 'Meses Médios', icon: Clock },
    { end: 150, suffix: '+', label: 'Caminhões Entregues', icon: Truck },
    { end: 45, suffix: '%', label: 'Economia vs Financiamento', icon: DollarSign }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              ...
              <span className="text-sm text-orange-300 font-medium">Consórcio de Caminhões</span>
            </div>
            ...
            >
              Conquiste o caminhão perfeito para seu negócio com nosso consórcio inteligente. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="group bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 mx-auto sm:mx-0"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Descubra as vantagens exclusivas que fazem do nosso consórcio a melhor opção para conquistar seu caminhão.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Escolha entre uma ampla variedade de caminhões, desde veículos leves até caminhões pesados e especiais.
            </p>
          </div>

          <div 
            ref={trucksAnimation.elementRef}
            className="grid md:grid-cols-2 gap-8"
          >
            {trucks.map((truck, index) => (
              <div 
                key={index}
                style={trucksAnimation.getItemStyle(index)}
              ...
              >
                <div className="flex items-center mb-4">
                  <div className={`w-12 h-12 bg-gradient-to-r ${truck.color} rounded-xl flex items-center justify-center mr-4`}>
                    <truck.icon className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white">{truck.category}</h3>
                    <p className="text-orange-400 font-medium">{truck.priceRange}</p>
                  </div>
                </div>
                
                <div className="space-y-2">
                  {truck.examples.map((example, idx) => (
          ...
          >
            {process.map((step, index) => (
              ...
              >
                ...
                <div className="w-8 h-8 bg-gradient-to-r from-orange-500 to-red-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-sm">
                  {step.step}
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500/10 to-red-500/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Comece agora mesmo sua simulação gratuita e descubra como podemos ajudar você a conquistar seu caminhão sem juros.
          </p>
