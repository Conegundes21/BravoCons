...
const MaquinariosPage: React.FC = () => {
  ...
  const machineTypes = [
    {
      icon: '🚜',
      title: 'Tratores',
      description: 'Equipamentos para agricultura e construção',
      examples: ['Trator Agrícola', 'Trator de Esteira', 'Mini Trator']
    },
    {
      icon: '🏗️',
      title: 'Carregadeiras',
      description: 'Máquinas para movimentação de materiais',
      examples: ['Pá Carregadeira', 'Retroescavadeira', 'Escavadeira']
    },
    {
      icon: '⚡',
      title: 'Equipamentos Elétricos',
      description: 'Máquinas com tecnologia avançada',
      examples: ['Betoneira Elétrica', 'Compressor', 'Gerador']
    },
    {
      icon: '🔧',
      title: 'Ferramentas Industriais',
      description: 'Equipamentos para indústria e oficinas',
      examples: ['Serra Circular', 'Furadeira', 'Esmerilhadeira']
    }
  ];
  ...
  const benefits = [
    {
      icon: TrendingUp,
      title: 'Sem Juros',
      description: 'Pague apenas o valor do equipamento, sem juros abusivos'
    },
    {
      icon: Shield,
  ...
  const values = [
    ...
    { credit: 'R$ 150.000', installment: 'R$ 1.470' },
    { credit: 'R$ 200.000', installment: 'R$ 1.960' }
  ];
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-yellow-500 to-amber-600 rounded-full mb-8">
              <Construction className="w-10 h-10 text-white" />
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">
              Consórcio de <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-400">Maquinários</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Potencialize sua produção com equipamentos de qualidade. 
              Sem juros, sem entrada e com planos personalizados para você.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-700 hover:to-amber-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Tipos de Maquinários Disponíveis
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Oferecemos consórcios para todos os tipos de equipamentos, desde pequenos até grandes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {machineTypes.map((type, index) => (
              <div 
                key={index}
                className={`bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 hover:border-yellow-500/50 transition-all duration-500 transform hover:scale-105 ${
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Por que escolher consórcio de maquinários?
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Vantagens exclusivas que fazem do consórcio a melhor opção para seus equipamentos
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-yellow-500 to-amber-600 rounded-full mb-6">
      ...
      <section className="py-20 bg-gray-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Confira as opções de crédito e parcelas disponíveis para maquinários
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {values.map((value, index) => (
              <div 
                key={index}
                className={`bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-gray-700 hover:border-yellow-500/50 transition-all duration-300 transform hover:scale-105 ${
                  isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 sm:p-12 border border-gray-700 ${
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Pronto para potencializar sua produção?
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Nossa equipe especializada está pronta para te ajudar a escolher o melhor plano 
              e iniciar sua jornada rumo aos equipamentos dos sonhos.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-700 hover:to-amber-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2">
                <Calculator className="w-5 h-5" />
